...
namespace ModernRecrut.MVC.Migrations
{
    ...
    [Migration("20231205081217_MigrationInit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModernRecrut.MVC.Models.Postulations.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ModernRecrut.MVC.Models.Postulations.Postulation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ModernRecrut.MVC.Models.User.Utilisateur", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ModernRecrut.MVC.Models.User.Utilisateur", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ModernRecrut.MVC.Models.Postulations.Note", b =>
                {
                    b.HasOne("ModernRecrut.MVC.Models.Postulations.Postulation", "Postulation")
                        .WithMany("Notes")
