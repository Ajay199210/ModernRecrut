...
namespace ModernRecrut.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Le mot de passe est obliatoire")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Assignation des attributs pour l'utilisateur
                ...
                if (result.Succeeded)
                {
                    ...
                    // Assignation des rôles pour l'utilisateur
                    if (user.Type == TypeUtilisateur.Employe)
                    {
